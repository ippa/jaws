...
== Learn more
* http://jawsjs.com/          - Official Jaws homepage. Jaws docs and design choices.
* {http://jawsjs.com/test/}[http://jawsjs.com/test/]    - Jaws QUnit testsuite
...
* http://jawsjs.com/source/examples/example3.html  - focus: Animation()
* http://jawsjs.com/source/examples/example4.html  - focus: Rect based collision detection
* http://jawsjs.com/source/examples/example5.html  - focus: Sprite({center: ...}) parameter
