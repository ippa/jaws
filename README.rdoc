...
Jaws also:
- Uses 2D canvas to draw stuff on the screen (with *very* exprimental DOM-sprite support)
...
== API-deprecations leading up to ver 1.0
  2013-08: SpriteList, Parallax and TileMap are no longer included in jaws(-min).js bundle
