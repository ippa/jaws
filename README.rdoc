...
== Highlights
  ...
  * Animation(), Sprite(), SpriteSheet() constructors
  * Comes with documented code and explained examples
...
== Examples
* http://ippa.se/jaws/examples/examples1.html
* http://ippa.se/jaws/examples/examples2.html
...
== Example Code
  ...
  <script>
    ...
    window.onload = jaws.start  // call setup(), then loop calling update() / game.draw() with FPS 60
  </script>
