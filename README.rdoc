  ...
  <script>
    ...
    function MyGameState() {
      ...
      this.setup = function() {
        ...
        robot.sheet = new jaws.SpriteSheet({image: "images/droid_11x15.png", frame_size : [11,15]});
        robot.animation = new jaws.Animation({frames: robot.sheet.frames, frame_duration: 120});
      }
