...
* http://jawsjs.com/source/examples/example5.html  - focus: the jaws.Sprite({anchor: "top_left"}) parameter

== Games using Jaws
* http://ippa.se/webgames/unwaivering/  - A Jaws-game for http://www.ludumdare.com/compo/2011/01/25/minild-24/
