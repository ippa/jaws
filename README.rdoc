...
Depends on Javascript 1.6+ (ECMA-262 Edition 5). Tested on Chrome 9+, Firefox 3.6.x/4.x, Safari 5+.
...
* http://jawsjs.com/jawsjs/examples/example7.html  - focus: DOM-based sprites
...
* jaws-dynamic.js - dynamically loads all separate jaws files. This is best for debugging errors in jaws.
  It assumes a directory "jawsjs" in your webpages "public" folder.
