...
Works with Chrome 9+, Firefox 3.6+, Safari 5+ & IE9.
...
* Jsdoc documentation, documented code & examples with comments
...
== Learn more
- {http://jawsjs.com/docs/}[http://jawsjs.com/docs/]                  - Jaws documentation
- {http://jawsjs.com/}[http://jawsjs.com/]                            - Official Jaws homepage. Overview and design choices.
- {http://jawsjs.com/jawsjs/test/}[http://jawsjs.com/jawsjs/test/]    - Jaws testsuite (QUnit)
...
* http://jawsjs.com/jawsjs/examples/example1.html - manual setup of canvas. later examples shows better ways.
...
== Games using Jaws
* {http://ippa.se/webgames/unexpected_outcome/}[http://ippa.se/webgames/unexpected_outcome/] - A 10-minute adventure game with pixel-perfect collisions
