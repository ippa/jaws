...
test("Collision detection", function() {
  var sprite1 = new jaws.Sprite({image: "assets/rect.png", x: 0, y: 0})
  var sprite2 = new jaws.Sprite({image: "assets/rect.png", x: 10, y: 10})
  var sprite3 = new jaws.Sprite({image: "assets/rect.png", x: 60, y: 60})
